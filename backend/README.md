...
## Project Structure
    ...
    ├── testapiautostorybo_115466  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_115466`
...
2. Clone this repo and `cd testapiautostorybo_115466`
